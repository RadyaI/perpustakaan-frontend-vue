                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form @submit.prevent="save">
                            ...
                            <input type="text" class="form-control" v-model="buku.judul_buku" id="nama" autocomplete="off"
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-body">
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal"><i class="bi bi-bookmark-plus"></i></button>
                                    <br><br>
...
export default {
    ...
    methods: {
        ...
        save_data() {
            ...
            // formData.append('file', this, this.file);
